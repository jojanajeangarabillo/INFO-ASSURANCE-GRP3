...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2026 at 04:08 AM
...
--
-- Table structure for table `locked_user`
--
...
INSERT INTO `user` (`user_id`, `username`, `email`, `password`, `otp_code`, `otp_expiry`, `verification_token`, `token_expiry`, `is_activated`, `mfa_secret`, `last_failed_login`, `attempts`, `is_locked`, `created_at`, `role_id`) VALUES
(6, 'test', 'n0305933@gmail.com', '$2y$10$.Y40Fpy2G.188piUPEVFzO.pd6QJD9rukbiTbHaAfBKyYYq0hXG6m', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00', 1, '', '2026-04-19 22:07:08', 0, 0, '2026-05-02 10:07:00', 2);
...
--
-- Indexes for table `locked_user`
--
ALTER TABLE `locked_user`
