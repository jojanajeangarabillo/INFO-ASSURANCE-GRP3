...
-- --------------------------------------------------------
-- Additional security and payment tables (non-destructive add)
-- --------------------------------------------------------
...
CREATE TABLE `login_history` (
  ...
  CONSTRAINT `fk_login_history_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
